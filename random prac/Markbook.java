public class Markbook
{
	...
	*/
	...
	{	// calculate the average grade for each student, then
		...
		averages[s] = counter/scores.length;
		s++;
		averages[s] = scoreToGrade[averages[s]];
        return averages;
	}
	}
	...
	{	// calculate the class average based on the 2D array with students scores
		...
		average1 = counter/scores.length;
		s++;
		sum = sum + average1;
		average = sum/scores[0].length;
        return average;
	}
